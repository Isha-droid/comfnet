...
const Header: React.FC = () => {
  return (
    <header className="relative bg-gray-800 py-16">
      <div className="container mx-auto text-center px-6">
        ...
        {/* Call to Action */}
        <button
          className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded mt-6 transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-400"
