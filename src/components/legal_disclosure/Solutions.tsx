    ...
    return (
        <div className="flex justify-center gap-8 bg-white p-10 rounded-md">
            ...
            <div className="flex flex-col gap-4 text-black">
                <div className="flex gap-6">
                    <div className="mt-6 flex flex-col gap-2">
                        <p className="flex items-center gap-2">
                            <span className="text-blue-500">📍</span> Kajen 10, 20459 Hamburg,
                            Germany
                        </p>
                        <p className="flex items-center gap-2">
                            <span className="text-blue-500">📞</span> +49 (0)17676534176
                        </p>
                        <p className="flex items-center gap-2">
                ...
                <div>
                    <h3 className="text-blue-600 font-bold">Represented by:</h3>
